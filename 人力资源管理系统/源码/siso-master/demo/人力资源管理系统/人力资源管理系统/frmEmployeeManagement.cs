...
namespace 人力资源管理系统
{
    public partial class frmEmployeeManagement : Form
    {
        ...
        public void FillData()
        {
            ...
            conn.Open();
            SqlDataAdapter da = new SqlDataAdapter("select * from 员工表", conn);
        ...
        {
            FindEmployee FrmFindEmployee = new FindEmployee();
            FrmFindEmployee.Text = "查询员工信息";
            FrmFindEmployee.ShowDialog(this);
        }

        private void btnAdd_Click(object sender, EventArgs e)
        {
            AddEmployee FrmAddEmployee = new AddEmployee();
            FrmAddEmployee.Text = "新增员工";
            FrmAddEmployee.ShowDialog(this);

        }

        private void btnChange_Click(object sender, EventArgs e)
        {
            //ChangeEmployee FrmChangeEmployee = new ChangeEmployee();
            //FrmChangeEmployee.Show();
            //**********************************************************************************************************
            if (dataGridView1.SelectedRows.Count == 0) return;
            ChangeEmployee modify = new ChangeEmployee();
            modify.Text = "修改员工信息";
            modify.员工号 = dataGridView1.SelectedRows[0].Cells["员工号"].Value.ToString();
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("确认删除选中的" + ROW.ToString() + "条记录吗？", "请确认删除", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                {
                    SqlCommand comm = new SqlCommand("delete from 员工表 where 员工号=@员工号", conn);
        ...
        {
            SearchInEmployee FrmSearchInEmployee = new SearchInEmployee();
            FrmSearchInEmployee.ShowDialog(this);
        }
