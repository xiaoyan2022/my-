...
<div id="main">
    ...
    <div id="content">
        ...
        <form action="#" onsubmit="return false">
            <table>
               <tr>
                   <td>标题</td><td><input type="text" id="title" value="${cul.title}"></td>
               </tr>
                <tr>
                    <td>内容</td><td><textarea rows="10" cols="60" id="myContent" >${cul.content}</textarea></td>
                </tr>
                <tr>
                    <td>是否开放评论 :
                    <c:if test="${cul.open==1}"><input type="radio" name="open" value="1" checked="checked">是&nbsp<input type="radio" name="open" value="0" >否</c:if>
                        <c:if test="${cul.open==0}"><input type="radio" name="open" value="1" >是&nbsp<input type="radio" name="open" value="0"  checked="checked">否</c:if>
                    </td>
                </tr>
                <tr><td><input type="submit" value="保存" onclick="save(${cul.cno})"></td></tr>
            </table>
        </form>
    </div>
</div>
...
<script>
    function save(cno) {
        ...
        window.location.href = "update_culture?title="+title+"&content="+content+"&cno="+cno+"&open="+getChecked()
    }
</script>
