...
<div id="main">
  ...
  <div id="mession">
    <div id="search">
      帖子名称
      <form action="goodListBySno" onsubmit="return false">
    ...
    <ul id="m_con">
     <c:forEach items="${good}" var="g">
       <li>
         <p><span class="wait">活动交流</span><span class="des" onclick="detail(${g.gid}">${g.name}</span></p>
         <p>发布者 : ${g.owner}<span style="margin-left:30px;margin-right: 30px;">发布时间:${g.time}</p>
       </li>
     </c:forEach>
    </ul>
  </div>
