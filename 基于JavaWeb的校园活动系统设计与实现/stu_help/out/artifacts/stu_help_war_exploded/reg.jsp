  ...
  <div id="mession">
    <ul id="m_con">
      <form action="reg" method="post" onsubmit="return check()">
        <table>
          <tr><td>学号 <input type="text" name="sno" id="sno"></td><td>注册成功后以学号登录</td><td><span style="color: red">${msg}</span></td></tr>
          <tr><td><span id="userNameReg"></span></td></tr>
          <tr><td>密码 <input type="password" name="pwd" id="pwd"></td><td>请务必牢记密码</td></tr>
          <tr><td><span id="passWordReg"></span></td></tr>
          <tr><td>姓名 <input type="text" name="name" id="name"></td></tr>
          <tr><td>学校 <input type="text" name="college" id="college"></td></tr>
          <tr><td>性别 <input type="radio" name="sex" value="1" checked>男 <input type="radio" name="sex" value="0">女</td></tr>
