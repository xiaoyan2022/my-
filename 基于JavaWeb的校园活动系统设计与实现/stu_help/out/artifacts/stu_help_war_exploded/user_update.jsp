  ...
  <div id="mession">
    <ul id="m_con">
      <form action="update_user" method="post" onsubmit="return check()">
        <table>
          <tr><td>用户姓名</td><td><input type="text" name="name" id="name" value="${user.name}"></td></tr>
          <tr><td>用户性别</td><td>
          ...
          <tr><td>学校</td><td><input type="text" name="college" id="college" value="${user.college}"></td></tr>
