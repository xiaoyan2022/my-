...
<div class="body-card layui-card">
    <form id="saveMovie" class="layui-form layui-form-pane" action="blog_add" method="post" style="margin-top:20px">
        <div class="layui-form-item">
            <label class="layui-form-label">游戏名称</label>
            <div class="layui-input-inline">
                <input type="text" name="type" placeholder="请输入游戏名称" required  class="layui-input" >
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="title" placeholder="请输入帖子标题" required class="layui-input" >
            </div>
            <div class="layui-form-mid layui-word-aux"><span class="color-warn"></span></div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <textarea type="text"  name="content"  required class="layui-input" style="height:200px;width:500px" ></textarea>
            </div>
