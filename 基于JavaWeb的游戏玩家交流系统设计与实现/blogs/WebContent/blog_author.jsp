...
<div class="body-card layui-card">
  			...
  			<div class="layui-inline" style="margin:10px">
	    		<label class="layui-form-label">游戏名称</label>
	   			<div class="layui-input-inline">
	      			<input type="text" name="name" placeholder="请输入游戏名称" class="layui-input" >
	    		</div>
  			</div>
  			<div class="layui-inline">
    			<label class="layui-form-label">帖子标题</label>
    			<div class="layui-input-inline">
      				<input type="text" name="type" placeholder="请输入帖子标题" class="layui-input" >
    			</div>
  			</div>
  			<div class="layui-inline">
		    	<div class="layui-input-inline">
	...
	<table class="layui-table">
	 	...
	 	<thead>
	  	...
	  	<tbody>
	  	<c:forEach items="${blogById }" var="b">
	  	<tr>
					<td>${b.id }</td>
					<td>${b.type}</td>
					<td>${b.title}</td>
					...
					<td>${b.uid}</td>
					<td>
						<a href="/movie/movieDetail?id=#(m.id)"><button class="layui-btn" type="button">查看详情</button></a>
					</td>
				</tr>
	  	</c:forEach>
