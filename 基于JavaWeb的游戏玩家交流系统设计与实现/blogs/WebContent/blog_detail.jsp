...
<div class="body-card layui-card">
        <div class="layui-form-item">
          <h1 style="text-align:center">${bl.title }</h1>
          <p style="text-align:center">${bl.type }专区&nbsp;&nbsp;作者 : admin${bl.name }&nbsp;&nbsp;${bl.create_time }</p>
          <p>${bl.content }</p>
        </div>
        <div class="layui-form-item" >
            <div class="layui-input-block">
                <button class="layui-btn" onclick="window.history.go(-1)" type="button">返回</button>
            </div>
        </div>
    </form>
</div>
