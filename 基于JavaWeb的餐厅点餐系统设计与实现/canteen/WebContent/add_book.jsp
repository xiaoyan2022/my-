...
<div id="zhu">
    ...
    <table>
	<tr><td>菜品图片:</td><td><input class="acc" type="file" name="myfile" /></td></tr>
	<tr><td>菜品名称:</td><td><input class="acc" type="text" name="name" /></td></tr>
	<tr><td>菜品类别:</td><td><input class="acc" type="text" name="author" /></td></tr>
	<tr><td>菜品口味:</td><td><input class="acc" type="text" name="publish" /></td></tr>
	<tr><td>菜品价格:</td><td><input class="acc" type="text" name="price" /></td></tr>
