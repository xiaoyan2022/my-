...
<body>
    <div class="box">
        ...
        <div class="right">
            <h4>管理员登录</h4>
             <form action="login?role=1" method="post" onsubmit="return check()">
 ...
 else if("用户名或密码错误".equals(msg)||"注册成功".equals(msg)||"修改密码成功，请重新登录".equals(msg)){%>
