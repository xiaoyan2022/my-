...
<style>
	*{margin: 0;padding: 0;}
	...
	#zhu{overflow:scroll;width: 80%;height: 570px;float: left;margin-left: 5px; box-shadow: 0px 0px 35px 0px #DDDDDD;z-index: 0;}
    #zhu img{
    width:180px;
    height:180px;
    }
...
<div id="zhu">
	...
	<table>
	<tr><td><img src="upload/${b.imgUrl }"></td></tr>
	<tr><td>菜品名称：${b.name }</td></tr>
	<tr><td>菜品类型：${b.author }</td></tr>
	<tr><td>菜品口味：${b.publish }</td></tr>
	<tr><td>菜品价格：${b.price }￥</td></tr>
	<tr><td><a href="add_cart?bid=${b.id }" id="add">添加到购物车</a></td></tr>
	</table>
	</c:forEach>
</div>
<!-- 引入 jQuery -->
