...
<style>
	*{margin: 0;padding: 0;}
	...
	#zhu{padding-top:10px;overflow:scroll;width: 80%;height: 560px;float: left;margin-left: 5px; box-shadow: 0px 0px 35px 0px #DDDDDD;z-index: 0;}
    #zhu img{
    width:180px;
    height:160px;
    }
...
<body>
	<div id="a1">
		<img src="img/logo_jw_d.png" style="vertical-align: bottom;">
			...
			<font size="6"><b><span id="top">&nbsp;欢迎进入餐厅点餐系统</span></b></font>
	</div>
	<div id="a2">
		<center>
		<div id="aa1">
...
<div id="tab1">
	<div id="tab2">
		<table border="0" cellspacing="0" cellpadding="0" id="t2">
			...
			<span style="text-align:right">欢迎用户 : <%=session.getAttribute("adName")%></span>
		</table>
	</div>
<div class="treebox">
	<ul class="menu">
		<li class="level1">
			<a href="#none"><em class="ico ico5"></em>菜品展示<i class="down"></i></a>
			<ul class="level2">
				<li><a href="bookShow">菜品展示</a></li>
			</ul>
		</li>
		<li class="level1">
			<a href="#none"><em class="ico ico5"></em>个人信息<i class="down"></i></a>
			<ul class="level2">
				<li><a href="update_user.jsp">信息修改</a></li>
				<li><a href="password.jsp">安全设置</a></li>
			</ul>
		</li>
		<li class="level1">
			<a href="#none"><em class="ico ico3"></em>购物车<i></i></a>
			<ul class="level2">
				<li><a href="cartListByUid" >我的购物车</a></li>
			</ul>
		</li>
	</ul>
</div>
...
<div id="zhu">
	<table >
	<tr><td>菜品图片</td><td>菜品名称</td><td>下单时间</td><td>价格</td><td>数量</td><td>操作</td></tr>
	<c:forEach items="${cartsById }" var="c">
	<tr>
	<td><img src="upload/${c.imgUrl }"></td>
	<td>${c.name }</td>
	<td>${c.time }</td>
	<td>${c.price }</td>
	<td>${c.num }</td>
	<td>
	<a href="update_cart?id=${c.id }&add=1" class="add">增加</a>
	<a href="update_cart?id=${c.id }&add=0" class="add">减少</a>
	<a href="del_cart?id=${c.id }" class="add">移除</a>
	</td>
	</tr>
	</c:forEach>
	</table>
