...
<div id="zhu">
    <form action="update_password"  method="post" onsubmit="return check()">
    <table>
	<tr><td>原密码:</td><td><input class="acc" type="password" name="old" id="old"/></td></tr>
	<input type="password" id="pre" value="${user.password }"/>
	<tr><td>新密码:</td><td><input class="acc" type="password" name="new1" id="new1" /></td></tr>
	<tr><td>再次输入新密码:</td><td><input class="acc" type="password" name="new2" id="new2" /></td></tr>
...
else if("修改密码成功，请重新登录".equals(msg)){%>
alert('<%=msg%>')
