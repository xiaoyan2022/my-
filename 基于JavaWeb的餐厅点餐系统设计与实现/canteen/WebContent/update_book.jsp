...
<div id="zhu">
    ...
    <table>
	<tr><td>菜品图片:</td><td><img src="upload/${book.imgUrl }"></td></tr>
	<tr><td>菜品名称:</td><td><input class="acc" type="text" name="name" value="${book.name }"/></td></tr>
	<tr><td>菜品类别:</td><td><input class="acc" type="text" name="author" value="${book.author }" /></td></tr>
	<tr><td>菜品口味:</td><td><input class="acc" type="text" name="publish" value="${book.publish }"/></td></tr>
	<tr><td>菜品价格:</td><td><input class="acc" type="text" name="price" value="${book.price }"/></td></tr>
