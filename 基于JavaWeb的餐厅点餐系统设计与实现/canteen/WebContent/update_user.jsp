...
<div id="zhu">
    ...
    <table>
	<tr><td>用户名:</td><td><input class="acc" type="text" value="${user.username }" readonly /></td></tr>
	<tr><td>昵称:</td><td><input class="acc" type="text" name="nickname" value="${user.nickname }" /></td></tr>
	<tr><td>地址:</td><td><input class="acc" type="text" name="address" value="${user.address }"/></td></tr>
	<tr><td>手机号:</td><td><input class="acc" type="text" name="tel" value="${user.tel }"/></td></tr>
	<tr><td colspan="2"><input type="submit" value="保存" class="submit"></td></tr>
	</table>
    </form>
    <%
